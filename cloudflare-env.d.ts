/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 2da1803e299cc1b2f7a69dbde570a214)
// Runtime types generated with workerd@1.20260917.1 2026-09-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	GLM_MODEL: "glm-5.3-flashx";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GLM_MODEL" | "DEEPSEEK_MODEL" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_PRICE_ID" | "RESEND_API_KEY" | "EMAIL_FROM" | "DEV_UNLOCK" | "SITE_URL" | "FALLBACK_API_KEY" | "DEEPSEEK_API_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "TURNSTILE_VERIFY_URL">> {}
}
