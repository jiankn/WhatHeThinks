...
const c: ToolContent = {
  ...
  faq: [
    ...
    { q: "Is my chat uploaded?", a: "No. The tool reads your chat in your browser. Nothing is sent to our servers." },
    {
      ...
      a: "On its own, not much. It matters when it's lopsided for months, or when it changes: going from half your conversations to one in five means more than the number itself. For the full picture, a [WhatsApp relationship analyzer](/whatsapp-relationship-analyzer) reads who starts alongside reply times and plans.",
    },
  ],
};
